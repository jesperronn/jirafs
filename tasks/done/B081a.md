# B081a: `jirafs mirror refresh` resolves project context and calls refresh service interface.
...
`jirafs mirror refresh` resolves project context and calls refresh service interface.
