# B016a: Non-interactive unresolved context returns a structured no-project error.
...
Non-interactive unresolved context returns a structured no-project error.
